 ...
 * 微信公众号"以数据之名"
 * @author: itbigbird
 * @createDate 2019年7月24日 下午2:16:54
 * @version v0.1
 * @describe ElasticSearchBulkDialog
 */
public class ElasticSearchBulkDialog extends BaseStepDialog implements
		StepDialogInterface {
	...
	public ElasticSearchBulkDialog(Shell parent, Object in,
	...
	public String open() {
		...
		shell.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.DialogTitle"));
   ...
   */
	private void addGeneralTab() {
		...
		wGeneralTab.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.General.Tab"));
	...
	private void fillIndexGroup(Composite parentTab) {
		...
		wIndexGroup.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.IndexGroup.Label"));
		...
		// Index
		wIndex = new LabelComboVar(transMeta, wIndexGroup,
				BaseMessages.getString(PKG, "ElasticSearchBulkDialog.Index"
						+ ".Label"), BaseMessages.getString(PKG,
						"ElasticSearchBulkDialog.Index.Tooltip"));
		props.setLook(wIndex);
		wIndex.getComboWidget().setEditable(true);
		wIndex.addModifyListener(lsMod);
		wIndex.addFocusListener(new FocusListener() {
			public void focusLost(org.eclipse.swt.events.FocusEvent e) {
			}

			public void focusGained(org.eclipse.swt.events.FocusEvent e) {
				getPreviousFields(wIndex);
			}
		});
		getPreviousFields(wIndex);
		...
		wType = new LabelTextVar(transMeta, wIndexGroup,
				BaseMessages.getString(PKG, "ElasticSearchBulkDialog.Type"
						+ ".Label"), BaseMessages.getString(PKG,
						"ElasticSearchBulkDialog.Type.Tooltip"));
		wType.addModifyListener(lsMod);

		// Test button
		wTest = new Button(wIndexGroup, SWT.PUSH);
		wTest.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.TestIndex.Label"));
		wTest.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.TestIndex.Tooltip"));
		...
		BaseStepDialog.positionBottomButtons(wIndexGroup,
				new Button[] { wTest }, Const.MARGIN, wType);
	...
	private void addServersTab() {
		...
		wServersTab.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.ServersTab.TabTitle"));
		...
		wTestCl.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.TestCluster.Label"));
		wTestCl.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.TestCluster.Tooltip"));
		...
		columnsMeta[0] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.ServersTab.Address.Column"),
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		columnsMeta[0].setUsingVariables(true);
		columnsMeta[1] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.ServersTab.Port.Column"),
				ColumnInfo.COLUMN_TYPE_TEXT, true);

		wServers = new TableView(transMeta, wServersComp, SWT.BORDER
				| SWT.FULL_SELECTION | SWT.MULTI, columnsMeta, 1, lsMod, props);
	...
	private void addSettingsTab() {
		...
		wSettingsTab.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.SettingsTab.TabTitle"));
		...
		ColumnInfo[] columnsMeta = new ColumnInfo[2];
		columnsMeta[0] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.SettingsTab.Property.Column"),
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		columnsMeta[1] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.SettingsTab.Value.Column"),
				ColumnInfo.COLUMN_TYPE_TEXT, false);
		columnsMeta[1].setUsingVariables(true);

		wSettings = new TableView(transMeta, wSettingsComp, SWT.BORDER
				| SWT.FULL_SELECTION | SWT.MULTI, columnsMeta, 1, lsMod, props);
		FormData fdServers = new FormData();
		fdServers.left = new FormAttachment(0, Const.MARGIN);
		fdServers.top = new FormAttachment(0, Const.MARGIN);
	...
	private void addFieldsTab() {
		...
		wFieldsTab.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.FieldsTab.TabTitle"));
		...
		String[] names = this.fieldNames != null ? this.fieldNames
				: new String[] { "" };
		ColumnInfo[] columnsMeta = new ColumnInfo[2];
		columnsMeta[0] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.NameColumn.Column"),
				ColumnInfo.COLUMN_TYPE_CCOMBO, names, false);
		columnsMeta[1] = new ColumnInfo(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.TargetNameColumn.Column"),
				ColumnInfo.COLUMN_TYPE_TEXT, false);

		wFields = new TableView(transMeta, wFieldsComp, SWT.BORDER
				| SWT.FULL_SELECTION | SWT.MULTI, columnsMeta, fieldsRowCount,
				lsMod, props);
	...
	private void fillOptionsGroup(Composite parentTab) {
		...
		wSettingsGroup.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.SettingsGroup.Label"));
		...
		wTimeOut = new LabelTimeComposite(wSettingsGroup,
				BaseMessages.getString(PKG, "ElasticSearchBulkDialog.TimeOut"
						+ ".Label"), BaseMessages.getString(PKG,
						"ElasticSearchBulkDialog.TimeOut.Tooltip"));
		props.setLook(wTimeOut);
		wTimeOut.addModifyListener(lsMod);

		// BatchSize
		wlBatchSize = new Label(wSettingsGroup, SWT.RIGHT);
		wlBatchSize.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.BatchSize.Label"));
		props.setLook(wlBatchSize);

		wBatchSize = new TextVar(transMeta, wSettingsGroup, SWT.SINGLE
				| SWT.LEFT | SWT.BORDER);
		...
		wlStopOnError.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.StopOnError.Label"));

		wStopOnError = new Button(wSettingsGroup, SWT.CHECK | SWT.RIGHT);
		wStopOnError.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.StopOnError.Tooltip"));
		...
		wIdInField = new LabelComboVar(transMeta, wSettingsGroup,
				BaseMessages.getString(PKG,
						"ElasticSearchBulkDialog.IdField.Label"),
				BaseMessages.getString(PKG,
		...
		wlIsOverwrite.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.Overwrite.Label"));

		wIsOverwrite = new Button(wSettingsGroup, SWT.CHECK | SWT.RIGHT);
		wIsOverwrite.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.Overwrite.Tooltip"));
		...
		wlUseOutput.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.UseOutput.Label"));

		wUseOutput = new Button(wSettingsGroup, SWT.CHECK | SWT.RIGHT);
		wUseOutput.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.UseOutput.Tooltip"));
		...
		wIdOutField = new LabelTextVar(transMeta, wSettingsGroup,
				BaseMessages.getString(PKG,
						"ElasticSearchBulkDialog.IdOutField.Label"),
				BaseMessages.getString(PKG,
		...
		wlIsJson.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.IsJson.Label"));

		wIsJson = new Button(wSettingsGroup, SWT.CHECK | SWT.RIGHT);
		wIsJson.setToolTipText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.IsJson.Tooltip"));
		...
		Control[] settingsControls = new Control[] { wlBatchSize, wBatchSize,
				wlStopOnError, wStopOnError, wTimeOut, wIdInField,
				wlIsOverwrite, wIsOverwrite, wlUseOutput, wUseOutput,
				wIdOutField, wlIsJson, wIsJson, wJsonField };
		...
		if (this.fieldNames == null) {
			try {
				...
				new ErrorDialog(
						...
						BaseMessages
								.getString(PKG,
										"ElasticSearchBulkDialog.FailedToGetFields.DialogTitle"),
						BaseMessages
								.getString(PKG,
										"ElasticSearchBulkDialog.FailedToGetFields.DialogMessage"),
						ke);
				return new String[0];
			}
		}
	...
	private void getPreviousFields(TableView table) {
		try {
			RowMetaInterface r = transMeta.getPrevStepFields(stepname);
			if (r != null) {
				BaseStepDialog.getFieldsFromPrevious(r, table, 1, new int[] {
						1, 2 }, null, 0, 0, null);
			}
		} catch (KettleException ke) {
			new ErrorDialog(shell, BaseMessages.getString(PKG,
					"System.Dialog.GetFieldsFailed.Title"),
					BaseMessages.getString(PKG,
	...
	public void getData(ElasticSearchBulkMeta in) {
		...
		wBatchSize.setText(Const.NVL(in.getBatchSize(), ""
				+ ElasticSearchBulkMeta.DEFAULT_BATCH_SIZE));
	...
	private void ok() {
		try {
			...
			new ErrorDialog(
					...
					BaseMessages
							.getString(PKG,
									"ElasticSearchBulkDialog.ErrorValidateData.DialogTitle"),
					BaseMessages
							.getString(PKG,
									"ElasticSearchBulkDialog.ErrorValidateData.DialogMessage"),
					e);
		}
		dispose();
	}
	...
	private void toModel(ElasticSearchBulkMeta in) throws KettleException { // copy
		...
		in.setOverWriteIfSameId(StringUtils.isNotBlank(wIdInField.getText())
				&& wIsOverwrite.getSelection());
	...
	private void test(TestType testType) {
		...
		try {
			...
			Map<String, String> tMetaMap = tempMeta.getSettingsMap();
			Iterator<Entry<String, String>> iter = tMetaMap.entrySet()
					.iterator();
			while (iter.hasNext()) {
				Entry<String, String> entry = (Entry<String, String>) iter
						.next();
				settingsBuilder.put(entry.getKey(), transMeta
						.environmentSubstitute(entry.getValue()));
			}

			try (PreBuiltTransportClient client = new PreBuiltTransportClient(
					settingsBuilder.build())) {

				for (Server server : tempMeta.getServers()) {

					client.addTransportAddress(new TransportAddress(InetAddress
							.getByName(transMeta.environmentSubstitute(server
									.getAddress())), server.getPort()));
				...
				case INDEX:
					if (StringUtils.isBlank(tempMeta.getIndex())) {
						showError(BaseMessages.getString(PKG,
								"ElasticSearchBulk.Error.NoIndex"));
						break;
					}
					// First check to see if the index exists
					IndicesExistsRequestBuilder indicesExistBld = admin
							.indices().prepareExists(tempMeta.getIndex());
					IndicesExistsResponse indicesExistResponse = indicesExistBld
							.execute().get();
					if (!indicesExistResponse.isExists()) {
						showError(BaseMessages.getString(PKG,
								"ElasticSearchBulkDialog.Error.NoIndex"));
						return;
					}

					RecoveryRequestBuilder indicesBld = admin.indices()
							.prepareRecoveries(tempMeta.getIndex());
					ActionFuture<RecoveryResponse> lafInd = indicesBld
							.execute();
					String shards = "" + lafInd.get().getSuccessfulShards()
							+ "/" + lafInd.get().getTotalShards();
					showMessage(BaseMessages.getString(PKG,
							"ElasticSearchBulkDialog.TestIndex.TestOK", shards));
					break;
				case CLUSTER:
					ClusterStateRequestBuilder clusterBld = admin.cluster()
							.prepareState();
					ActionFuture<ClusterStateResponse> lafClu = clusterBld
							.execute();
					...
					showMessage(BaseMessages.getString(PKG,
							"ElasticSearchBulkDialog.TestCluster.TestOK", name,
							numNodes));
					break;
				default:
					break;
	...
	private void showMessage(String message) {
		...
		mb.setText(BaseMessages.getString(PKG,
				"ElasticSearchBulkDialog.Test.TestOKTitle"));
		mb.open();
	}
